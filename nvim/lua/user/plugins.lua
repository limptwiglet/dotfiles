...
return packer.startup(function(use)
  ...
  -- cmp plugins
  use { "hrsh7th/nvim-cmp", commit = "0a9ccdf1225632fc2b355e62bf77b9ff218baaf8" } -- The completion plugin
  ...
  use { "neovim/nvim-lspconfig", commit = "c5505c70571b094663745167d40388edd40f6450" } -- enable LSP
